...
Made during my last year of highschool in 2019 as my "exam project" (Gymnasiearbete).

The game is controlled by speaking Swedish. The game works by using the Google [Cloud Speech-to-text](https://cloud.google.com/speech-to-text/) API and a whole lot of if/else statements. My free trial for the API has expired and thus the game won't work unless a new API-key is provided.
...
For more information of the game and it's development, read the [report](Rapport.docx) (swedish)
